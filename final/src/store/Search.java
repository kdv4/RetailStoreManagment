...
public class Search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ProductTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Product Id", "Product Name", "Qty", "Purchase Cost", "Selling Cost"
            }
        ) {
        ...
        SellTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill No", "Date", "Type ", "AcID", "Account Name"
            }
        ) {
            Class[] types = new Class [] {
...
if(actype.getSelectedItem()=="Product")
{
    ...
    private void valKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valKeyPressed
       ...
       jdbc a=new jdbc();
        ...
        try
        {
            ...
            {
                query="select a.Acid,a.name,b.SBId,b.Bill_Date from ac_detail a,sell_bill_detail b where a.name like '%"+key+"%' and a.ACId=b.ACId ";
                ...
                while(a.rs.next())
                {
                    ...
                    int d5=a.rs.getInt("b.SBId"); //Billno
                    String d4=a.rs.getString("b.Bill_Date"); //date
                    String d3="Selling";//type
                    
                    modelS.addRow(new Object[]{d5,d4,d3,d1,d2});  
                }
                query="select a.Acid,a.name,b.Purchase_No,b.Bill_Date from ac_detail a,buying_purchase_detail b where a.name like '%"+key+"%' and a.ACId=b.ACId ";
                a.stmt=a.con.prepareStatement(query);
                a.rs=a.stmt.executeQuery();
                while(a.rs.next())
                {
                    int d1=a.rs.getInt("a.ACId");
                    String d2=a.rs.getString("a.Name");
                    int d5=a.rs.getInt("b.Purchase_No"); //Billno
                    String d4=a.rs.getString("b.Bill_Date"); //date
                    String d3="Purchase";//type
            ...
            {
                query="select a.item_code,a.pname,a.pid,b.qty,b.selling_cost,b.purchase_cost from inventory a,stock b where a.Pname like '%"+key+"%' and a.item_code=b.item_code";
                a.stmt=a.con.prepareStatement(query);
                a.rs=a.stmt.executeQuery();
                while(a.rs.next())
                {
                    int d1=a.rs.getInt("a.Item_code");
                    String d2=a.rs.getString("a.PName");
                    String d5=a.rs.getString("a.PId");
                    int d4=a.rs.getInt("b.qty");//qty
                    float d3=a.rs.getInt("b.Purchase_cost");//purchase
                    float d6=a.rs.getInt("b.Selling_cost");//selling
                   
                    modelP.addRow(new Object[]{d1,d5,d2,d4,d3,d6});  
                }
            }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try
        {
             query="select a.Acid,a.name,b.SBId,b.Bill_Date from ac_detail a,sell_bill_detail b where a.ACId=b.ACId ";
                a.stmt=a.con.prepareStatement(query);
                a.rs=a.stmt.executeQuery();
                while(a.rs.next())
                {
                ...
                query="select a.Acid,a.name,b.Purchase_No,b.Bill_Date from ac_detail a,buying_purchase_detail b where  a.ACId=b.ACId ";
                a.stmt=a.con.prepareStatement(query);
                a.rs=a.stmt.executeQuery();
                while(a.rs.next())
                {
              ...
              query="select a.item_code,a.pname,a.pid,b.qty,b.selling_cost,b.purchase_cost from inventory a,stock b where  a.item_code=b.item_code";
                a.stmt=a.con.prepareStatement(query);
                a.rs=a.stmt.executeQuery();
                while(a.rs.next())
                {
